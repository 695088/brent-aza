...
const sections = [
  {
    ...
    questions: [
      ...
      {
        id: "d3",
        text: "How many people currently live in your household?",
        type: "single",
        options: [
          "1 person (just me)",
          "2 people",
      ...
      {
        id: "d4",
        text: "How often do you cook meals at home each week?",
        type: "single",
        options: [
          "Rarely (0 – 1 times)",
          "Occasionally (2 – 3 times)",
          "Regularly (4 – 5 times)",
          "Very frequently (6 – 7 times)",
    ...
    constructs: [
      {
        ...
        questions: [
          {
            id: "l1",
            text: "I am bothered by how much money my household spends on food that ultimately gets thrown away.",
          },
          {
            id: "l2",
            text: "I would pay for an app if I believed it could meaningfully reduce my monthly grocery bill.",
          },
        ],
      },
      {
        ...
        questions: [
          {
            id: "l3",
            text: "I am more likely to use a food management app regularly if it requires minimal manual data entry.",
          },
          {
            id: "l4",
            text: "An app that automatically suggests meals based on ingredients I already have would simplify my daily routine.",
          },
        ],
      },
      {
        ...
        questions: [
          {
            id: "l5",
            text: "Reducing the amount of food I throw away is personally important to me for environmental reasons.",
          },
          {
            id: "l6",
            text: "I actively look for products and services that help me live in a more environmentally responsible way.",
          },
        ],
      },
    ],
  },
  {
    ...
    questions: [
      {
        id: "a1",
        text: "How likely are you to download a free app that tracks your pantry's expiration dates and suggests meals based on what's about to expire?",
        type: "single",
        options: [
          "Definitely would not download it",
          "Probably would not download it",
          "Neutral / unsure",
          "Probably would download it",
          "Definitely would download it",
        ],
      },
      {
        id: "a2",
        text: "In the past 6 months, how often have you thrown away food because it expired before you could use it?",
        type: "single",
        options: [
          "Never",
          "Once or twice",
          ...
          return (
            ...
            >
              ...
              <span style={{
                fontFamily: "'Lato', sans-serif",
                fontSize: "0.65rem",
                color: selected ? sectionColor : COLORS.muted,
...
export default function PantryPalSurvey() {
  const [answers, setAnswers] = useState({});
  const [submitted, setSubmitted] = useState(false);
  const [activeSection, setActiveSection] = useState("demographic");

  const totalQuestions = 10; // 4 demo + 6 likert + 2 attitudinal — wait: 4+6+2 = 12 but attitudinal is in separate section
    ...
    return (
      <div style={{
        ...
        <div style={{ textAlign: "center", maxWidth: 460 }}>
          ...
          <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "2rem", fontWeight: 700, color: COLORS.ink, marginBottom: "0.5rem" }}>
            Thank you!
          </h2>
          ...
          <div style={{ marginTop: "1.5rem", padding: "1rem 1.5rem", background: COLORS.accentLight, borderRadius: "12px", border: `1px solid ${COLORS.accent}33` }}>
            <p style={{ fontFamily: "'Lato', sans-serif", fontSize: "0.85rem", color: COLORS.accent, fontWeight: 600, margin: 0 }}>
              {answered} of 12 questions answered
            </p>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 720, margin: "0 auto", position: "relative" }}>
          <div style={{
            ...
            background: COLORS.accent + "33", border: `1px solid ${COLORS.accent}55`,
            color: COLORS.accent, fontSize: "0.72rem", fontWeight: 700,
            letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "0.9rem",
          }}>Customer Discovery Survey</div>
          <h1 style={{
            fontFamily: "'Cormorant Garamond', serif",
            fontSize: "clamp(1.8rem, 5vw, 2.8rem)",
            fontWeight: 700, color: "#faf7f2",
                ...
                <div key={ci} style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      background: section.color + "22", border: `1.5px solid ${section.color}55`,
                      display: "flex", alignItems: "center", justifyContent: "center",
                      color: section.color, fontWeight: 800, fontSize: "0.85rem",
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "1.5rem" }}>
                <button
                  ...
                  style={{
                    ...
                    opacity: sections.findIndex(s => s.id === activeSection) === 0 ? 0.3 : 1,
                  }}
                >
                  ← Previous
                </button>
